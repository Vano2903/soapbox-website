...
export async function GET({ url }) {
	...
	const data = await fetchSheetData(`'Cl. ${leaderboard} [${category.toUpperCase()}]'!${leaderboardRanges.get(leaderboard)}`)
...
// function formatSheetData(values: string[][]): string {
...
function formatSheetDataFromFullJson(json: any): string {
