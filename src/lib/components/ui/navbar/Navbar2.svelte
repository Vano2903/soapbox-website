...
<nav class="relative flex items-center justify-between bg-red-500">
	...
	<div class="flex">
		<a class=" mb-2 flex items-center bg-white pr-4 leading-none lg:pr-10" href="/">
			...
			<span class="hidden h-12 items-end whitespace-nowrap pb-2 text-base/6 md:flex">
				<span class="text-4xl font-bold">ASD</span>&nbsp;&nbsp;
				<span class="hidden text-3xl lg:block"><span class="text-4xl">B</span>OXRALLY</span>
			</span>
			<!-- <span class="font-bold"> <span class="h-24">B</span>OXRALLY</span>
		<span class="h-12">C</span>LUB -->
		</a>
	...
	<!-- <div class="inline-block w-full items-center justify-between">
		<div class="logo">
			<img class="h-12" src="/images/navbar/logo.jpg" alt="Logo ASD box rally" />
			<a href="/" class="name inline-block">
				<span class="font-bold"> <span class="h-24">B</span>OXRALLY</span>
				<span class="h-12">C</span>LUB
			</a>
		</div>
...
<style lang="postcss">
	.triangle {
		...
		height: 50px; */
		border-style: solid;
		border-width: 3rem 30px 0 0;
		/* @apply border-t-0 border-r-0 border-b- */
		/* @apply border-b-red-500 border-l-transparent border-r-transparent border-t-transparent; */
		@apply border-b-transparent border-l-transparent border-r-transparent border-t-white;
		/* border-color: transparent transparent #007bff transparent; */
	}

	.name {
		@apply inline-table text-nowrap text-2xl;
	}
	.logo {
