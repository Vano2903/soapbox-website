<script lang="ts">
	...
	const sections = [
		...
		},
		{
			...
			content:
				'Curve? Tornanti? Per noi è solo l’inizio! Aggiungiamo scalinate in pietra, prati, chicane, salti mozzafiato, vasche d’acqua e tunnel di schiuma. Ogni ostacolo mette alla prova mezzi e abilità, regalando colpi di scena al pubblico. Le rotture sono frequenti, ma anche quelle fanno ridere e uniscono: non c’è tifo avverso, solo incitamenti per tutti. Per noi ogni evento è una grande festa dove l’imprevisto diventa leggenda.',
			pages: [
				{
					layout: 'horizontal',
		...
		},
		{
			...
			content:
				'Siamo un gruppo di appassionati decisi a rilanciare questo sport. Il sito e i social sono il nostro diario di bordo: foto, video e consigli tecnici. Organizziamo eventi collaborando con comuni e Pro Loco, e abbiamo rilanciato il campionato che nell’ultimo millennio ha funto da collante per tutti i piloti. Cerchiamo nuovi alleati per crescere perché per noi l’obiettivo è uno solo: divertirsi come ragazzini, oggi e per altri 70 anni.',
			pages: [
				{
					layout: 'horizontal',
					horizontal: {
