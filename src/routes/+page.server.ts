...
export const load: PageServerLoad = async () => {
	...
	const [currentChampionship, err] = (await goCatch(pb.collection('championships').getFirstListItem('ongoing=true', { sort: '-startDate', expand: 'events' }))) as [ChampionshipExpand, undefined] | [undefined, Error];
	...
	console.log("events.at(" + nextEventIndex + ") = " + currentChampionship.expand.events.at(nextEventIndex));
