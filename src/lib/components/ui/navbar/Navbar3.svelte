...
<!-- component -->
<nav class="relative flex items-center justify-between bg-white px-4 py-4">
	...
	<div class="lg:hidden">
		<button class="navbar-burger flex items-center p-3 text-blue-600">
			<svg
	...
	<ul
		class="absolute left-1/2 top-1/2 hidden -translate-x-1/2 -translate-y-1/2 transform lg:mx-auto lg:flex lg:flex lg:w-auto lg:items-center lg:space-x-6"
	>
	...
	<a
		class="hidden rounded-xl bg-gray-50 px-6 py-2 text-sm font-bold text-gray-900 transition duration-200 hover:bg-gray-100 lg:ml-auto lg:mr-3 lg:inline-block"
		href="#">Sign In</a
	>
	<a
		class="hidden rounded-xl bg-blue-500 px-6 py-2 text-sm font-bold text-white transition duration-200 hover:bg-blue-600 lg:inline-block"
		href="#">Sign up</a
	>
</nav>
